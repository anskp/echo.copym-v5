...
const inputPath = './public/assets/svg/aboutusheroo.png';
const outputPath = './public/assets/svg/aboutusheroo.avif';
...
console.log('Starting AVIF conversion for aboutusheroo.png...\n');
convertToAvif();