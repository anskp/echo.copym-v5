...
const inputPath = './src/components/images/about-us-bg.png';
const outputPath = './src/components/images/about-us-bg.avif';
...
console.log('Starting AVIF conversion for about-us-bg.png...\n');
convertToAvif();