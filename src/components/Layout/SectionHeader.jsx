...
const SectionHeader = ({
  ...
  return (
    ...
    >
      ...
      {subtitle && (
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-center text-black font-normal leading-relaxed tracking-wide mt-3 sm:mt-4" style={{ fontFamily: 'Palanquin, sans-serif' }}>
          {subtitle}
        </p>
      )}
    </motion.div>
