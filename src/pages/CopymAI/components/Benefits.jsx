...
const Benefits = () => {
  return (
    <section className="relative isolate mt-72 sm:mt-80 lg:mt-[28rem] bg-black text-white px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20 lg:mb-24">
          <h2 className="text-4xl md:text-5xl font-black leading-tight dm-sans mb-4 uppercase tracking-tight">
        ...
        <div className="space-y-6 lg:space-y-10">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="group relative overflow-hidden rounded-[24px] border border-emerald-500/25 bg-[#050708] p-8 sm:p-10 shadow-[0_30px_100px_rgba(0,0,0,0.65)] transition-transform duration-300 hover:-translate-y-1">
              <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                <div className="max-w-xl space-y-4">
                  <h3 className="text-2xl sm:text-3xl font-semibold text-emerald-400">
                ...
                <div className="shrink-0 flex justify-center md:justify-end">
                  <img
                    ...
                    className="w-28 sm:w-32 lg:w-36 drop-shadow-[0_20px_45px_rgba(21,163,110,0.45)]"
                  />
                </div>
              </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            <div className="group relative overflow-hidden rounded-[24px] border border-emerald-500/25 bg-[#050708] p-8 sm:p-10 shadow-[0_25px_90px_rgba(0,0,0,0.6)] transition-transform duration-300 hover:-translate-y-1">
              ...
              <div className="mt-8 flex justify-center">
                <img
                  ...
                  className="w-28 sm:w-32 drop-shadow-[0_20px_45px_rgba(21,163,110,0.45)]"
                />
              </div>
              <div className="pointer-events-none absolute inset-0 rounded-[24px] ring-1 ring-emerald-500/10 ring-offset-0" />
            </div>
            ...
            <div className="group relative overflow-hidden rounded-[24px] border border-emerald-500/25 bg-[#050708] p-8 sm:p-10 shadow-[0_25px_90px_rgba(0,0,0,0.6)] transition-transform duration-300 hover:-translate-y-1">
              ...
              <div className="mt-8 flex justify-center">
                <img
                  ...
                  className="w-32 sm:w-36 drop-shadow-[0_20px_45px_rgba(21,163,110,0.45)]"
                />
              </div>
              <div className="pointer-events-none absolute inset-0 rounded-[24px] ring-1 ring-emerald-500/10 ring-offset-0" />
            </div>

            <div className="group relative overflow-hidden rounded-[24px] border border-emerald-500/25 bg-[#050708] p-8 sm:p-10 shadow-[0_25px_90px_rgba(0,0,0,0.6)] transition-transform duration-300 hover:-translate-y-1 md:col-span-2 xl:col-span-1">
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-emerald-400">
