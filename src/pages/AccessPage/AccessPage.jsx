             ...
             <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-8 sm:mt-12 lg:mt-16">
                ...
                <div className="text-center">
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                      <img src="/assets/Images/icons/t6.png" alt="Compliance-first" className="w-5 h-5 sm:w-5 sm:h-5 lg:w-6 lg:h-6 object-contain filter brightness-0 invert" />
                    </div>
                ...
                <div className="text-center">
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                      <img src="/assets/Images/icons/agraph.png" alt="Utility & Access" className="w-5 h-5 sm:w-5 sm:h-5 lg:w-6 lg:h-6 object-contain filter brightness-0 invert" />
                    </div>
                ...
                <div className="text-center">
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                      <img src="/assets/Images/icons/m1.png" alt="Multi-asset Support" className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 object-contain filter brightness-0 invert" />
                    </div>
                ...
                <div className="text-center">
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                      <img src="/assets/Images/icons/a5.png" alt="Security & Trust" className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 object-contain filter brightness-0 invert" />
                    </div>
                ...
                <div className="text-center">
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                      <img src="/assets/Images/icons/t3.png" alt="Global Access" className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 object-contain filter brightness-0 invert" />
                    </div>
