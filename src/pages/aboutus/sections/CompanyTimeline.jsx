      ...
      <div className="w-full bg-background-primary mt-16 sm:mt-20 md:mt-24 lg:mt-[-134px]">
        <div className="w-full max-w-[1920px] mx-auto px-6 sm:px-8 md:px-10 lg:px-[46px] py-6 sm:py-8 md:py-10 lg:py-[46px]">
          ...
          <div className="flex flex-col gap-8 sm:gap-12 md:gap-16 lg:gap-[70px] justify-start items-center w-full h-full">
            ...
            {/* Section Title */}
            <h2 className="text-[20px] sm:text-[26px] md:text-[32px] lg:text-[40px] font-bold leading-[36px] sm:leading-[46px] md:leading-[58px] lg:leading-[72px] text-center uppercase text-text-white font-palanquin w-auto">
              ...
              <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-[28px] w-full">
                ...
                <div className="flex flex-col lg:flex-row justify-start items-center w-full lg:w-[1256px] mt-2 lg:mt-[10px] mb-64 sm:mb-80 md:mb-96 lg:mb-[542px]">
                  <div className="flex flex-col lg:flex-row justify-start items-center w-full lg:w-[40%]">
                    ...
                    />
                    <h3 className="text-[16px] sm:text-[21px] md:text-[26px] lg:text-[32px] font-semibold leading-[29px] sm:leading-[38px] md:leading-[46px] lg:leading-[57px] text-center text-text-accent font-palanquin w-full lg:w-[58%] mt-4 lg:mt-[42px] ml-0 lg:ml-[-8px]">
                      {timelineData?.[0]?.year}
                    </h3>
                  </div>
                  ...
                  <div className="flex flex-row justify-center items-center w-full lg:w-[60%] self-end mb-0 lg:mb-[34px] mt-4 lg:mt-0">
                    <div className="flex flex-col justify-start items-center w-[94%]">
                      <p className="text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-normal leading-[22px] sm:leading-[29px] md:leading-[36px] lg:leading-[43px] text-left text-text-white font-palanquin w-auto">
                        {timelineData?.[0]?.description}
                      </p>
                      <p className="text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-normal leading-[22px] sm:leading-[29px] md:leading-[36px] lg:leading-[43px] text-left text-text-white font-palanquin w-auto -mt-11 sm:-mt-14 md:-mt-18 lg:-mt-[86px]">
                        {timelineData?.[0]?.description}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col lg:flex-row justify-center items-start w-full">
                  ...
                  />
                  <h3 className="text-[16px] sm:text-[21px] md:text-[26px] lg:text-[32px] font-semibold leading-[29px] sm:leading-[38px] md:leading-[46px] lg:leading-[57px] text-left text-text-accent font-palanquin w-full lg:w-[24%] mt-2 lg:mt-[10px] ml-0 lg:ml-[20px]">
                    {timelineData?.[1]?.year}
                  </h3>
                  <p className="text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-normal leading-[22px] sm:leading-[29px] md:leading-[36px] lg:leading-[43px] text-left text-text-white font-palanquin w-full lg:w-[58%] mt-4 lg:mt-[20px] ml-0 lg:ml-[54px]">
                ...
                <div className="flex flex-col lg:flex-row justify-start items-start w-full mt-4 lg:mt-0">
                  <div className="flex flex-col lg:flex-row justify-center items-center w-full lg:w-[44%] px-0 lg:px-[30px] self-center">
                    ...
                    />
                    <h3 className="text-[16px] sm:text-[21px] md:text-[26px] lg:text-[32px] font-semibold leading-[29px] sm:leading-[38px] md:leading-[46px] lg:leading-[57px] text-left text-text-accent font-palanquin w-full lg:w-[58%] mt-4 lg:mt-0 ml-0 lg:ml-[18px]">
                      {timelineData?.[2]?.year}
                    </h3>
                  </div>
                  
                  <p className="text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-normal leading-[22px] sm:leading-[29px] md:leading-[36px] lg:leading-[43px] text-left text-text-white font-palanquin w-full lg:w-[56%] mt-4 lg:mt-[24px]">
