    ...
    <section className="w-full bg-background-primary">
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[56px] py-12 sm:py-16 md:py-20 lg:py-[62px] mr-0 lg:mr-[8px]">
        <div className="flex flex-col items-center justify-start w-full gap-3 lg:gap-[12px]">
          ...
          {/* Section Title */}
          <h2 className="text-[20px] sm:text-[26px] md:text-[32px] lg:text-[40px] font-bold leading-[36px] sm:leading-[46px] md:leading-[58px] lg:leading-[72px] text-center uppercase text-text-accent font-palanquin w-auto">
            Company Overview
          </h2>
          ...
          <div className="flex flex-col lg:flex-row justify-start items-center w-full mr-0 lg:mr-[22px]">
            ...
            <div className="flex flex-col justify-start items-end w-full lg:w-[58%] lg:ml-[1px]">
              ...
              {/* Main Description */}
              <p className="text-[10px] sm:text-[13px] md:text-[16px] lg:text-[20px] font-normal leading-[18px] sm:leading-[23px] md:leading-[29px] lg:leading-[36px] text-left capitalize text-text-white font-palanquin w-full lg:w-[86%]">
                COPYm is a cutting-edge Real World Asset (RWA) tokenization platform designed to transform how the world perceives and manages ownership.
                <br /><br />
              ...
              <h3 className="text-[16px] sm:text-[20px] md:text-[26px] lg:text-[32px] font-bold leading-[29px] sm:leading-[36px] md:leading-[46px] lg:leading-[57px] text-center capitalize text-text-secondary font-palanquin w-auto mt-8 sm:mt-12 md:mt-16 lg:mt-[56px] ml-0 lg:ml-[104px] self-start">
                Why We Exist
              </h3>

              <p className="text-[10px] sm:text-[13px] md:text-[16px] lg:text-[20px] font-normal leading-[18px] sm:leading-[23px] md:leading-[29px] lg:leading-[36px] text-left capitalize text-text-white font-palanquin w-full lg:w-[86%] mt-2 sm:mt-4 lg:mt-[10px]">
