        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <button 
              ...
              className="bg-white text-emerald-600 font-semibold px-8 py-4 rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          {currentStep === 3 && (
            <div className="text-center mt-12">
              <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-2xl p-8 mb-8">
                <h3 className="text-2xl font-bold text-white mb-4">Ready to Tokenize!</h3>
                <p className="text-white/80 mb-6">
                  You've selected {selectedAsset?.name} on {selectedBlockchain?.name} using {selectedStandard?.name}
                </p>
                <button
                  onClick={onLaunchCreator}
                  className="inline-flex items-center justify-center px-8 py-4 font-semibold text-emerald-600 bg-white hover:bg-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
