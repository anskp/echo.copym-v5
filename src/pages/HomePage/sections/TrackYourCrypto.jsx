    ...
    <section className="relative py-12 sm:py-16 lg:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-32">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex justify-center items-center relative mt-8 lg:mt-12">
          ...
          <div className="space-y-6 text-left">
            <div className="space-y-6">
              <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-black leading-tight" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                DOWNLOAD <span className="text-emerald-600">COPYM</span> FROM YOUR <span className="text-emerald-600">FAVOURITE</span> APP STORE
              </h2>
              <p className="text-base text-black leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button className="bg-black hover:bg-gray-800 text-white flex items-center justify-center space-x-2 px-4 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 w-48 h-12 border border-gray-300">
