    ...
    <section className="relative py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start lg:ml-20 mt-8 lg:mt-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-start items-start">
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-black hover:bg-gray-800 text-white flex items-center justify-center space-x-3 px-8 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 w-56 h-12 border border-gray-300">
                ...
                {/* QR Code - Positioned to the right of Google Play button */}
                <div className="p-4">
