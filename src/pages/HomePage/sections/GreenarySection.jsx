...
export const GreenarySection = () => {
  return (
    <section className="relative w-full bg-white pt-4 pb-0 sm:py-8 md:py-12 lg:py-16 xl:py-20 overflow-x-hidden overflow-y-visible">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        ...
        <div className="relative flex items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[2rem] lg:rounded-[2.5rem] xl:rounded-[3.5rem] overflow-hidden">
          ...
          {/* Overlay Content */}
          <div className="absolute inset-0 flex flex-col items-center justify-end sm:justify-center px-4 sm:px-6 md:px-8 pb-2 sm:pb-10">
            ...
            <div className="flex items-center justify-center w-full max-w-full sm:mt-72 md:mt-[340px] lg:mt-[430px] xl:mt-[490px]">
              <button
                ...
                className="bg-black rounded-full px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 py-2.5 sm:py-2.5 md:py-3 lg:py-3.5 xl:py-4 flex items-center justify-center gap-2 sm:gap-2.5 md:gap-3 lg:gap-4 xl:gap-5 transition-all duration-200 border border-gray-800 w-auto sm:w-auto max-w-[90%] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl overflow-hidden min-w-0 cursor-pointer hover:scale-105 active:scale-95"
              >
